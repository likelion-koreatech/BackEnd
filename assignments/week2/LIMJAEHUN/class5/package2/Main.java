...
public class Main {
    public static void main(String[] args) {
        ...
        Repository repoMock = new MockMemberRepository();
        Repository repoMemory = new MemoryMemberRepository();
        MemberService memberService = new MemberService(repoMemory);
//        MemberService memberService2 = new MemberService(repoMock);
